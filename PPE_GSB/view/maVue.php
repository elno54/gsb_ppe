	...
	public function header() {
		...
		echo'<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link" href="http://172.19.0.20/PPE_GSB/index.php">Home </a>
						</li>';
						if(isset($_SESSION['pseudo'])){
							echo '
								<li class="nav-item">
									<a class="nav-link" href="http://172.19.0.20/PPE_GSB/index.php?action=commandes">Mes commandes</a>
								</li>';
						}
						echo'
						<li class="nav-item">
							<a class="nav-link " href="http://172.19.0.20/PPE_GSB/index.php?action=panier">Produits</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="http://172.19.0.20/PPE_GSB/index.php?action=consulterPanier">Panier</a>
						</li>';
						if(!isset($_SESSION['pseudo'])){
							echo '
							<li class="nav-item">
								<a class="nav-link " href="http://172.19.0.20/PPE_GSB/index.php?action=user">Inscription</a>
							</li>
							';
						}
						if(!isset($_SESSION['pseudo'])){
							echo '
							<li class="nav-item">
								<a class="nav-link " href="http://172.19.0.20/PPE_GSB/index.php?action=connexion">Connexion</a>
							</li>
							';
						}
						if(isset($_SESSION['pseudo'])){
							echo '
							<li class="nav-item">
								<a class="nav-link " href="http://172.19.0.20/PPE_GSB/index.php?action=profil">Profil</a>
							</li>
							';
						}
						if(isset($_SESSION['pseudo'])){
							echo '
							<li class="nav-item">
								<a class="nav-link " href="http://172.19.0.20/PPE_GSB/index.php?action=deconnecter">Deconnexion</a>
							</li>
							';
						}
						echo '
